...
final class KeyboardShortcutSettingsFileStoreTests: XCTestCase {
    ...
    func testBootstrapCreatesCommentedTemplateWhenPrimaryAndFallbackAreMissing() throws {
        ...
        XCTAssertTrue(contents.contains(#""$schema": "https://raw.githubusercontent.com/Lcc1ccl/cmax/main/docs/cmax-settings.schema.json""#))
    ...
    func testSettingsFileStoreParsesJSONCCommentsAndTrailingCommas() throws {
        ...
        try writeSettingsFile(
            """
            {
              "$schema": "https://raw.githubusercontent.com/Lcc1ccl/cmax/main/docs/cmax-settings.schema.json",
              "schemaVersion": 1,
              // tmux-like prefix
              "shortcuts": {
                "bindings": {
